...
# PyMuPDF find_tables() is accurate but very slow on some PDFs; skip for bulk ingest speed.
def _skip_native_tables() -> bool:
    return os.getenv("PDF_SKIP_TABLES", "").strip().lower() in ("1", "true", "yes")
