...
# Serialize Chroma access when ingestion runs in a background thread alongside API queries.
...
class _LazyCollection:
    """Defer loading sentence-transformers until first Chroma use; lock all collection I/O."""
    ...
    def __getattr__(self, name):
        ...
        def wrapped(*args, **kwargs):
            with _chroma_lock:
                return getattr(_get_collection(), name)(*args, **kwargs)
